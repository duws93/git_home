          ...
          try{
            ...
            warnError('拉取代码失败信息回调失败'){
              retry(5){httpRequest acceptType: 'APPLICATION_JSON', consoleLogResponseBody: true, contentType: 'APPLICATION_JSON', \
                       ...
                       timeout: 5, url: 'http://135.251.206.39:80/jenkins/job_finish', validResponseCodes: '200', validResponseContent: 'ok'
                      }
            }
          }
        }
    ...
    stage('完成'){
      steps{
        ...
        retry(5){
          ...
          responseHandle: 'NONE', timeout: 5, url: 'http://135.251.206.39:80/jenkins/job_finish', validResponseContent: 'ok'
        }
      }
    }
  }
